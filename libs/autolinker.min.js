  ...
  return (
    (a.prototype = {
      ...
      processHtml: function(a) {
        for (
          var b, c, d = this.htmlRegex, e = 0, f = 0, g = [];
          null !== (b = d.exec(a));
          ...
          var h = b[0],
            i = b[2],
            j = !!b[1];
          (c = a.substring(e, b.index)),
            (e = b.index + h.length),
            "a" === i
              ? j
                ? ((f = Math.max(f - 1, 0)), 0 === f && g.push(c))
                : (f++, g.push(this.processTextNode(c)))
              : g.push(0 === f ? this.processTextNode(c) : c),
            g.push(h);
        }
        if (e < a.length) {
      ...
      processTextNode: function(a) {
        ...
        return a.replace(c, function(a, c, g, h, i, j, k, l) {
          ...
          if (
            ...
            (q && !f) ||
            (q && -1 === q.indexOf(".")) ||
            (q && /^[A-Za-z]{3,9}:/.test(q) && !/:.*?[A-Za-z]/.test(q)) ||
            (r && /^[\w]\/\//.test(r))
          )
            return a;
      ...
      createAnchorAttrsStr: function(a, b) {
        ...
        return (
          d && c.push('class="' + d + '"'),
          this.newWindow && c.push('target="_blank"'),
          c.join(" ")
        );
      },
